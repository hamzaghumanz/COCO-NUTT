...
//  Journey30
//
//  Created by Macbook 5 on 2/6/23.
//
...
extension CALayer {
    ...
    func addTopLeftRight(borderWidth:CGFloat,borderColor:UIColor) {
        addBorder(side: .top, thickness: borderWidth, color: borderColor.cgColor,maskedCorners: [.layerMaxXMinYCorner,.layerMinXMinYCorner])
        addLeftRight(borderWidth: borderWidth, borderColor: borderColor)
    }
    
    func addBottomLeftRight(borderWidth:CGFloat,borderColor:UIColor) {
        addBorder(side: .bottom, thickness: borderWidth, color: borderColor.cgColor,maskedCorners: [.layerMaxXMaxYCorner,.layerMinXMaxYCorner])
        addLeftRight(borderWidth: borderWidth, borderColor: borderColor)
    }
    
    func addLeftRight(borderWidth:CGFloat,borderColor:UIColor) {
        addBorder(side: .left, thickness: borderWidth, color: borderColor.cgColor)
        addBorder(side: .right, thickness: borderWidth, color: borderColor.cgColor)
    }
}
